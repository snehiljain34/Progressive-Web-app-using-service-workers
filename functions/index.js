...
var serviceAccount = require("./travelara-fb-key.json");

var gcconfig = {
    projectId: "travelara-2908c",
    keyFilename: "travelara-fb-key.json"
};
...
admin.initializeApp({
    ...
    databaseURL: "https://travelara-2908c.firebaseio.com/"
});
...
exports.storePostData = functions.https.onRequest(function(request, response) {
    cors(request, response, function() {
        ...
        busboy.on("finish", () => {
            var bucket = gcs.bucket("travelara-2908c.appspot.com");
            bucket.upload(
                upload.file, {
                    uploadType: "media",
                    metadata: {
